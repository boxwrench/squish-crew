...
export class Baby {
  ...
  constructor(body:SoftBody) {
    ...
    const material=new THREE.MeshPhysicalNodeMaterial({
      color:JELLY_FLAVORS[DEFAULT_JELLY_FLAVOR].surface,roughness:.045,metalness:0,transmission:1,thickness:.035,
      ior:1.333,dispersion:.015,attenuationDistance:.035,
      clearcoat:.42,clearcoatRoughness:.05,envMapIntensity:1.5,
      emissive:'#006bdf',emissiveIntensity:.09,
  ...
  update(dt=0,playing=false) { this.face.update(dt,playing); }
