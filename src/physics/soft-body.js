...
export class SoftBody {
  ...
  step(h) {
    ...
    this.quietTime=this.canSleep&&!this.grab&&this.grounded&&this.stepFraction>=.999&&rms<PHYS.sleepSpeed?this.quietTime+h:0;
  ...
  stepJS(h) {
    ...
    // oscillation has dissipated (15 mm/s RMS for 0.45 s at this 7 cm scale).
    this.quietTime=this.canSleep&&!this.grab&&this.grounded&&this.stepFraction>=.999&&rms<PHYS.sleepSpeed?this.quietTime+h:0;
